...
{
    public partial class MantePedidoVendedor : System.Web.UI.Page
    {
        ...
        void cargar()
        {
            ...
            grvDetalles.DataSource = db.ListarPedidosVendedor(id);
        ...
        {
            Response.Redirect("PedidoVendedor.aspx", true);
        }
    }
}