<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmReporteBlanco.aspx.cs" Inherits="PedidosCegal.Reportes.frmReporteBlanco" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Arial" Font-Size="10pt" Height="724px" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Width="100%" EnableTheming="True" SizeToReportContent="True">
            <LocalReport ReportPath="Reportes/ReporteBlanco.rdlc"></LocalReport>
        </rsweb:ReportViewer>
        </div>
    </form>
</body>
