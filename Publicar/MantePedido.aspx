<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="MantePedido.aspx.cs" Inherits="PedidosCegal.MantePedido" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <%--<div class="form-group ">
        <div class="col-sm-12">
            <div class="panel panel-primary">--%>
               <%-- <div class="panel-heading"><b>Comprobantes de Venta</b></div>--%>
